  ...
  return (
    <Layout>
      <section className="terms-page">
        ...
        <h2>OVERVIEW</h2>
        <p>
          This website is operated by Starbright Applied Behavior Analyst PLLC.
          Throughout the site, the terms “we”, “us” and “our” refer to
          Starbright Applied Behavior Analyst PLLC. Create Cosmos offers this
        ...
        <p>
          ...
          by our <Link to="/privacy">Privacy Policy.</Link>
        </p>
        ...
        <ul>
          ...
          <li>
            In no case shall Starbright Applied Behavior Analyst PLLC, our
        ...
        <p>
          You agree to indemnify, defend and hold harmless Starbright Applied
          Behavior Analyst PLLC and our parent, subsidiaries, affiliates,
        ...
        <h2>SECTION 20 - CONTACT INFORMATION</h2> Questions about the Terms of
        Service should be sent to us at{" "}
        <a href="mailto:alisa_lanzetta@starbrightaba.com">
          alisa_lanzetta@starbrightaba.com
        </a>
        .
      </section>
    </Layout>
